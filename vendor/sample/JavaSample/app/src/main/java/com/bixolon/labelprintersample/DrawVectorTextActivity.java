...
public class DrawVectorTextActivity extends Activity implements View.OnClickListener, DialogInterface.OnClickListener {
	...
	private void printLabel() {
		...
		switch (radioGroup.getCheckedRadioButtonId()) {
		case R.id.radio4:
			alignment = BixolonLabelPrinter.VECTOR_FONT_TEXT_ALIGNMENT_LEFT;
			break;
		case R.id.radio5:
			alignment = BixolonLabelPrinter.VECTOR_FONT_TEXT_ALIGNMENT_RIGHT;
			break;
		case R.id.radio6:
			alignment = BixolonLabelPrinter.VECTOR_FONT_TEXT_ALIGNMENT_CENTER;
			break;
		}
		...
		if (radioGroup.getCheckedRadioButtonId() == R.id.radio8) {
			direction = BixolonLabelPrinter.VECTOR_FONT_TEXT_DIRECTION_RIGHT_TO_LEFT;
		}
